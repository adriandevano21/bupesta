<table id="tabel1" class="table table-bordered" style="font-size: 12pt">
    ...
    <tbody class="border-black" id="dataoutput">
            ...
            @if ($databulanan->kode_sub1_indikator === '1')
                @if (
                    ...
                    <tr style="font-weight: bold;">
                        <form method="POST" action="/update-data/{{ $databulanan->id }}" enctype="multipart/form-data">
                            @csrf
